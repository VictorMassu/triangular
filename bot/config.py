...
MOEDAS_BLACKLIST = {"FDUSD","1000SATS"} # {"BRL", "ARS", "UAH", "TRY", "VAI", "EUR", "FDUSD"}
...
USE_BYBIT = os.getenv("USE_BYBIT", "true").lower() == "true"
...
if AMBIENTE == "test":
    ...
    API_KEY_BYBIT = os.getenv("API_KEY_BYBIT_PROD")
    SECRET_BYBIT = os.getenv("SECRET_BYBIT_PROD")
    BASE_URL_BYBIT = os.getenv("BASE_URL_BYBIT_PROD")
